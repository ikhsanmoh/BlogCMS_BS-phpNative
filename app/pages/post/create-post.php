      ...
      <div class="col-md-9 mb-5">
        ...
        <div class="card mb-3">
          ...
          <div class="card-body">
            ...
            <form action="<? echo $base; ?>app/pages/post/proses-add-post.php" method="post">
              ...
              <div class="form-group">
                ...
                <input type="text" class="form-control" id="meta_description" name="meta_desc">
              </div>

              <? if ( isset($_GET['status']) && $_GET['status'] == "err_title" ) : ?>

                <div class="row mb-2">
                  <div class="col-md-12">
                    <div class="alert alert-danger" role="alert">
                      Judul Post yang Anda masukan sudah ada!
                    </div>
                  </div>
                </div>
              ...
              <div class="form-group float-right">
                ...
                <input type="submit" class="btn btn-success" name="form_add_post">
              </div>
            </form>
